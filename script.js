const SHEET_CSV_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vSosfBP3StMyRUzwI0tUZPsLjPVH1zePCz8gZbTMOzjOvnonbmNCoy5VT46UxO0qdqb-Wm9EqTpXp8y/pub?gid=989357250&single=true&output=csv'; // <<< REPLACE THIS!
...
function initMap(data) {
    ...
    map = L.map('advisory-map').setView([17.5, 121.0], 8); 
